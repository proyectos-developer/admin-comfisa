        ...
        <div className='position-relative' 
            ...
            <div className='' style={{width: '100%', height: 'auto', marginBottom: 20 / proporcional}}>
                <p style={{fontSize: 16 / proporcional, lineHeight: `${25 / proporcional}px`, color: 'black', marginBottom: 0, fontFamily: 'Poppins, sans-serif',
                        fontWeight: 500}}>
                    Número de pedido: <span style={{fontSize: 16 / proporcional, fontWeight: 600}}>{get_cotizacion_usuario.cotizaciones[0].nro_pedido}</span>
                </p>
                <p style={{fontSize: 18 / proporcional, lineHeight: `${25 / proporcional}px`, color: 'black', marginBottom: 0, fontFamily: 'Poppins, sans-serif',
                        fontWeight: 500}}>
                    Fecha:: <span style={{fontSize: 18 / proporcional, fontWeight: 600}}></span>{get_cotizacion_usuario.cotizaciones[0].created_at.split('T')[0]}
                </p>
            </div>
            <div className='' style={{width: '100%', height: 'auto', marginBottom: 20 / proporcional}}>
                <p style={{fontSize: 16 / proporcional, lineHeight: `${25 / proporcional}px`, color: 'black', marginBottom: 0, fontFamily: 'Poppins, sans-serif',
            ...
            <div className='d-flex justify-content-center' style={{width: '100%', height: 50 / proporcional}}>
                <button className='btn' style={{width: '100%', height: 50 / proporcional, background: 'rgb(56, 77, 167)', color: 'white', fontSize: 20 / proporcional,
