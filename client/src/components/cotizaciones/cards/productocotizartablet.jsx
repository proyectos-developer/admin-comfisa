...
export default function CardProductoCotizarTablet({proporcional, producto, index}) {
    ...
    return (
        <div className='rounded' style={{width: '100%', height: 175 / proporcional, marginBottom: 10 / proporcional, border: '1px solid #f0f0f0'}}>
            <div className='d-flex rounded' style={{width: '100%', height: 100 / proporcional,
                ...
                <div className='d-flex justify-content-center' style={{width: '5%', height: 75 / proporcional, borderRight: '1px solid #f0f0f0'}}>
                    <p style={{fontSize: 16 / proporcional, lineHeight: `${75 / proporcional}px`, color: 'black', marginBottom: 0, fontFamily: 'Poppins, sans-serif',
                            fontWeight: 500}}>
                        {index + 1}
                    </p>
                </div>
                <div className='d-flex justify-content-start' style={{width: '35%', height: 75 / proporcional, borderRight: '1px solid #f0f0f0'}}>
                    <div style={{width: '135%', height: 75 / proporcional, paddingLeft: 10 / proporcional, paddingRight: 10 / proporcional}}>
                ...
                <div className='d-flex justify-content-center' style={{width: '10%', height: 75 / proporcional, borderRight: '1px solid #f0f0f0',
                    ...
                    <p style={{fontSize: 16 / proporcional, lineHeight: `${75/ proporcional}px`, color: 'black', marginBottom: 0, fontFamily: 'Poppins, sans-serif',
                            fontWeight: 500}}>
                        <span style={{fontSize: 16 / proporcional, fontWeight: 500}}>{producto.cantidad}</span>
                    </p>
                </div>
                <div className='d-flex justify-content-center' style={{width: '15%', height: 75 / proporcional, borderRight: '1px solid #f0f0f0',
            ...
            <div className='d-flex' style={{width: '100%', height: 74 / proporcional, padding: 12 / proporcional}}>
                <div style={{width: '20%', height: 50 / proporcional, borderRight: '1px solid #f0f0f0'}}>
                    <p style={{fontSize: 16 / proporcional, lineHeight: `${50 / proporcional}px`, color: 'black', marginBottom: 0, fontFamily: 'Poppins, sans-serif',
                            fontWeight: 500}}>
                        Observaciones
                    </p>
