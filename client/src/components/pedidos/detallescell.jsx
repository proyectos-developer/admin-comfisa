...
import CardProductoCotizarCell from './cards/productocotizarcell.jsx'
...
export default function DetallesPedidoCell({proporcional}) {
    ...
    return (
        <div className='position-relative' 
            ...
            <div className='d-flex justify-content-center' style={{width: '100%', height: 30 / proporcional, marginBottom: 20 / proporcional}}>
                <p style={{fontSize: 24 / proporcional, lineHeight: `${30 / proporcional}px`, marginBottom: 0, fontWeight: 500, color: '#212121'}}>
                    Estado pedido: <span style={{fontSize: 28 / proporcional, fontWeight: 600,
            ...
            <div className='' style={{width: '100%', height: 'auto', marginBottom: 20 / proporcional}}>
                ...
                <p style={{fontSize: 18 / proporcional, lineHeight: `${25 / proporcional}px`, color: 'black', marginBottom: 0, fontFamily: 'Poppins, sans-serif',
                        fontWeight: 500}}>
                    Fecha:: <span style={{fontSize: 18 / proporcional, fontWeight: 600}}></span>{lista_productos && lista_productos.length > 0 ? lista_productos[0].created_at.split('T')[0] :''}
                </p>
            </div>
            <div className='' style={{width: '100%', height: 'auto', marginBottom: 18 / proporcional}}>
                <p style={{fontSize: 16 / proporcional, lineHeight: `${25 / proporcional}px`, color: 'black', marginBottom: 0, fontFamily: 'Poppins, sans-serif',
                        fontWeight: 500}}>
                    Cliente: <span style={{fontSize: 18 / proporcional, fontWeight: 600}}>{usuario.nombres} {usuario.apellidos}</span>
                </p>
                <p style={{fontSize: 16 / proporcional, lineHeight: `${25 / proporcional}px`, color: 'black', marginBottom: 0, fontFamily: 'Poppins, sans-serif',
                        fontWeight: 500}}>
                    Teléfono: <span style={{fontSize: 18 / proporcional, fontWeight: 600}}>{usuario.nro_telefono}</span>
                </p>
                <p style={{fontSize: 16 / proporcional, lineHeight: `${25 / proporcional}px`, color: 'black', marginBottom: 0, fontFamily: 'Poppins, sans-serif',
                        fontWeight: 500}}>
                    Correo electrónico: <span style={{fontSize: 18 / proporcional, fontWeight: 600}}>{usuario.correo}</span> 
                </p>
            </div>
            <div className='' style={{width: '100%', height: 'auto', marginBottom: 20 / proporcional}}>
                ...
                </div>
                {
                    lista_productos && lista_productos.length > 0 ? (
                        lista_productos.map ((producto, index) => {
                            return (
                                <CardProductoCotizarCell proporcional={proporcional} producto={producto} index={index} />
                            )
                        })
                    ) : null
                } 
