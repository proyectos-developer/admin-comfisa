...
import CardPedidoTablet from './cards/pedidotablet.jsx'

export default function ListaPedidosTablet({proporcional}) {
                        ...
                        lista_pedidos.map ((pedido, numcot) => {
                            return (
                                <div key={numcot} className='d-flex justify-content-between' 
                                    ...
                                    {
                                        pedidos[(3 *  numcot)] ? ( 
                                            <CardPedidoTablet pedido={pedidos[(3 *  numcot)]} key={(3 *  numcot)} index={(3 *  numcot)} proporcional={proporcional}/>
                                        ) : null
                                    }
                                    {
                                        pedidos[(3 *  numcot) + 1] ? ( 
                                            <CardPedidoTablet pedido={pedidos[(3 *  numcot) + 1]} key={(3 *  numcot) + 1} index={(3 *  numcot) + 1} proporcional={proporcional}/>
                                        ) : null
                                    }
                                </div>
                            )
