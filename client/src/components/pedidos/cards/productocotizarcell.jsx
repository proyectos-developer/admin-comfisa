        ...
        <div className='rounded shadow d-flex' style={{width: '100%', height: 'auto', marginBottom: 10 / proporcional, border: '1px solid #f0f0f0'}}>
            ...
            <div style={{width: '95%', height: 'auto'}}>
                <div className='d-flex rounded' style={{width: '100%', height: 100 / proporcional,
                    ...
                    <div className='d-flex justify-content-center' style={{width: '20%', height: 75 / proporcional, borderRight: '1px solid #f0f0f0'}}>
                ...
                <div className='d-flex rounded' style={{width: '100%', height: 100 / proporcional,
                    ...
                    <div className='d-flex justify-content-center' style={{width: '20%', height: 75 / proporcional, borderRight: '1px solid #f0f0f0',
                        ...
                        <p style={{fontSize: 16 / proporcional, lineHeight: `${37.5/ proporcional}px`, color: 'black', marginBottom: 0, fontFamily: 'Poppins, sans-serif',
                                fontWeight: 600, textAlign: 'center'}}>Cant.<br/>
                ...
                <div className='d-flex' style={{width: '100%', height: 74 / proporcional, padding: 12 / proporcional}}>
                    <div className='d-flex justify-content-center' style={{width: '20%', height: 50 / proporcional, borderRight: '1px solid #f0f0f0',
                        paddingLeft: 10 / proporcional, paddingRight: 10 / proporcional}}>
                    ...
                    <div className='d-flex justify-content-center' style={{width: '80%', height: 50 / proporcional}}>
                        <textarea
                            disabled={true}
