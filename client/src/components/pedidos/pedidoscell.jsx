...
import CardPedidoCell from './cards/pedidocell.jsx'

export default function ListaPedidosCell({proporcional}) {
    ...
    useEffect (() => {
        if (get_pedidos_filtro_total && get_pedidos_filtro_total.pedidos && get_pedidos_filtro_total.success === true){
            console.log (get_pedidos_filtro_total)
            setListaPedidos (get_pedidos_filtro_total.pedidos)
        }
    ...
    <div className='position-relative' style={{width: '100%', paddingLeft: 20 / proporcional, paddingRight: 20 / proporcional}}>
        <div className='d-flex' style={{width: '100%', height: 'auto', marginBottom: 25 / proporcional }}>
            <div className='' style={{width: '100%', height: 'auto'}}>
                <div className='' style={{width: '100%', marginBottom: 10 / proporcional, height: 50 / proporcional}}>
                    <p className='mb-0' 
                ...
                <div className='shadow-sm bg-white rounded' 
                    style={{width: '100%', marginBottom: 10 / proporcional, height: 50 / proporcional, border: '1px solid #B2DFDB', borderRadius: 4 / proporcional,
                            }}>
                    <select
                ...
                <div className='d-flex shadow-sm bg-white rounded' 
                    style={{width: '100%', marginBottom: 10 / proporcional, height: 50 / proporcional, border: '1px solid #B2DFDB', borderRadius: 4 / proporcional}}>
                    <input
                        style={{width: '90%', height: 48 / proporcional, fontSize: 18 / proporcional, lineHeight: `${48 / proporcional}px`, fontWeight: 500, color: '#212121',
                    ...
                    />
                    <div className='d-flex justify-content-between' style={{width: '10%', height: 24 / proporcional}}>
                        ...
                        lista_pedidos.map ((pedido, numcot) => {
                            return (
                                <div key={numcot} className='d-flex justify-content-between' 
                                    ...
                                    <CardPedidoCell pedido={pedido} key={numcot} index={numcot} proporcional={proporcional}/>
                                </div>
                            )
                        })
                    ) : null
