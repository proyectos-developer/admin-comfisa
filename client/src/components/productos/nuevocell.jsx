    ...
    return (
        <div className='position-relative' 
            ...
            <div className='d-flex shadow-sm bg-white rounded' 
                ...
                <input type='text'
                    style={{fontFamily: 'Mukta, sans-serif', width: '58%', height: 48 / proporcional, fontSize: 16 / proporcional, lineHeight: `${48 / proporcional}px`, fontWeight: 500, color: '#212121'}}
                    className='form-control border-0 '
            ...
            <div style={{width: '100%', height: 110 / proporcional, marginBottom: 20 / proporcional}}>
            ...
            <div className='d-flex justify-content-between' 
                style={{width: '100%', height: 50 / proporcional, marginBottom: 20 / proporcional}}>
                <div className='d-flex shadow-sm bg-white rounded' 
                    style={{width: '49%', height: 50 / proporcional, border: '1px solid #B2DFDB', 
                                                borderRadius: 4 / proporcional}}>
            ...
            <div className='d-flex justify-content-between' style={{width: '100%', marginBottom: 20 / proporcional}}>
                <div style={{width: '49%', height: 'auto', border: efoto_uno ? '1px solid red' : 'none'}}>
                    {
                        foto_uno === '' ? ( 
                            <div className='' 
                                style={{width: '100%', height: 220 / proporcional, marginBottom: 20 / proporcional}}>
            ...
            </div>
            {
                open_menu_derecho ? ( 
                    <div className='position-absolute shadow rounded' 
                            ...
                            <div className='d-flex' style={{width: 270 / proporcional, height: 'auto', marginBottom: 20 / proporcional, cursor: 'pointer'}}
                            ...
                            <div className='rounded-pill' style={{width: 270 / proporcional, height: 2 / proporcional, background: '#e29022', marginBottom: 20 / proporcional}}/>
                        <div className='d-flex' style={{width: 270 / proporcional, height: 'auto', marginBottom: 20 / proporcional, cursor: 'pointer'}}
