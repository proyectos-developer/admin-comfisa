...
export default function NuevoProducto({proporcional}) {
    ...
    return (
        <div className='position-relative' 
                ...
                <div style={{width: 600 / proporcional, height: 262 / proporcional, marginLeft: 25 / proporcional}}>
                    <div className='d-flex justify-content-end' style={{width: 600 / proporcional, marginBottom: 5 / proporcional}}>
                        <div className='d-flex shadow-sm bg-white rounded' 
                            style={{width: 290   / proporcional, height: 50 / proporcional, border: '1px solid #B2DFDB', marginRight: 5 / proporcional,
                    ...
                    <div className='d-flex shadow-sm bg-white rounded' 
                        style={{width: 600 / proporcional, height: 50 / proporcional, border: enombre_producto ? '1px solid red' : '1px solid #B2DFDB', 
                        ...
                        <input type='text'
                            style={{fontFamily: 'Mukta, sans-serif', width: 390 / proporcional, height: 46 / proporcional, fontSize: 18 / proporcional, lineHeight: `${46 / proporcional}px`, fontWeight: 500, color: '#212121',
                                    }}
                    ...
                    <div style={{width: 600 / proporcional, height: 152 / proporcional, marginBottom: 5 / proporcional}}>
                        <div className='shadow-sm bg-white rounded' style={{width: 600 / proporcional, height: 134 / proporcional, 
                            ...
                            <textarea
                                ...
                                style={{fontFamily: 'Mukta, sans-serif', width: 598 / proporcional, height: 132 / proporcional, fontSize: 18 / proporcional, lineHeight: `${18 / proporcional}px`, fontWeight: 500, color: '#212121'}}
                                className='form-control border-0 '
                        ...
                        <p style={{fontFamily: 'Mukta, sans-serif', width: 600 / proporcional, paddingTop: 2 / proporcional, fontSize: 12 / proporcional, 
            ...
            <div style={{with: 920 / proporcional, height: 'auto'}}>
                <div className='d-flex' 
                    style={{width: 920 / proporcional, height: 50 / proporcional, marginBottom: 25 / proporcional}}>
                    <div className='d-flex shadow-sm bg-white rounded' 
                        style={{width: 296   / proporcional, height: 50 / proporcional, border: '1px solid #B2DFDB', 
                        ...
                        <input type='number'
                            style={{fontFamily: 'Mukta, sans-serif', width: 206 / proporcional, height: 46 / proporcional, fontSize: 18 / proporcional, lineHeight: `${46 / proporcional}px`, fontWeight: 500, color: '#212121',
                                    }}
                            className='form-control border-0 '
                            value={cantidad}
                    ...
                    <div className='d-flex shadow-sm bg-white rounded' 
                        style={{width: 296   / proporcional, height: 50 / proporcional, border: '1px solid #B2DFDB', marginRight: 5 / proporcional,
                                                    borderRadius: 4 / proporcional, marginLeft: 5 / proporcional}}>
                        <select
                            style={{fontFamily: 'Mukta, sans-serif', width: 236 / proporcional, height: 46 / proporcional, fontSize: 18 / proporcional, lineHeight: `${46 / proporcional}px`, fontWeight: 500, color: '#212121',
                                    }}
                            className='form-select border-0 '
                            value={medida}
                    ...
                    <div className='d-flex shadow-sm bg-white rounded' 
                        style={{width: 296 / proporcional, height: 50 / proporcional, 
                        ...
                        <div className='d-flex justify-content-center' style={{width: 130 / proporcional, height: 32 / proporcional, marginTop: 9 / proporcional,
                ...
                <div style={{width: 920 / proporcional, height: 'auto', marginBottom: 25 / proporcional}}>
                    <div className='d-flex shadow-sm bg-white rounded' 
                        style={{width: 920 / proporcional, height: 100 / proporcional, border: '1px solid #B2DFDB',
                                                    borderRadius: 4 / proporcional}}>
                        <textarea 
                            style={{fontFamily: 'Mukta, sans-serif', width: 948 / proporcional, height: 98 / proporcional, fontSize: 18 / proporcional, lineHeight: `${46 / proporcional}px`, fontWeight: 500, color: '#212121',
                                    }}
                            cols={2}
                            className='form-control border-0 '
                    ...
                    <p style={{fontFamily: 'Mukta, sans-serif', width: 920 / proporcional, paddingTop: 2 / proporcional, fontSize: 12 / proporcional, 
                ...
                <div className='d-flex' style={{width: 920 / proporcional}}>
                    <div style={{width: 220 / proporcional, height: 220 / proporcional, border: efoto_uno ? '1px solid red' : 'none', marginRight: 10 / proporcional}}>
                        {
                            foto_dos === '' ? ( 
                                <div className='position-relative' 
                                    style={{width: 218 / proporcional, height: 218 / proporcional, marginRight: 25 / proporcional}}>
                                    <div style={{width: 218 / proporcional, height: 218 / proporcional, background: '#bdbdbd', marginRight: 25 / proporcional, borderRadius: 4 / proporcional}}/>
                                ...
                                <div className='position-relative' 
                                    style={{width: 218 / proporcional, height: 218 / proporcional, marginRight: 25 / proporcional}}>
                                    <AvatarEditor
                                        width={218 / proporcional}
                                        height={218 / proporcional}
                                        image={foto_dos}
                                        color={[255, 255, 255, 0]}
                                        borderRadius={parseFloat(4)}
                                        scale={1.0}
                    ...
                    <div style={{width: 220 / proporcional, height: 220 / proporcional, border: efoto_uno ? '1px solid red' : 'none', marginLeft: 5 / proporcional, marginRight: 5 / proporcional}}>
                        {
                            foto_tres === '' ? ( 
                                <div className='position-relative' 
                                    style={{width: 218 / proporcional, height: 218 / proporcional, marginRight: 25 / proporcional}}>
                    ...
                    <div style={{width: 220 / proporcional, height: 220 / proporcional, border: efoto_uno ? '1px solid red' : 'none', marginLeft: 10 / proporcional}}>
                        {
                            foto_cinco === '' ? ( 
                                <div className='position-relative' 
                                    style={{width: 218 / proporcional, height: 218 / proporcional, marginRight: 25 / proporcional}}>
