                ...
                <div style={{width: 561 / proporcional, height: 262 / proporcional, marginLeft: 25 / proporcional}}>
                    <div className='d-flex justify-content-end' style={{width: 561 / proporcional, marginBottom: 5 / proporcional}}>
                        <div className='d-flex shadow-sm bg-white rounded' 
                            style={{width: 280.5   / proporcional, height: 50 / proporcional, border: '1px solid #B2DFDB', marginRight: 5 / proporcional,
                                                        borderRadius: 4 / proporcional, marginLeft: 5 / proporcional}}>
                            <select
                                disabled={!editar}
                                style={{fontFamily: 'Mukta, sans-serif', width: 278.5 / proporcional, height: 46 / proporcional, fontSize: 18 / proporcional, lineHeight: `${46 / proporcional}px`, fontWeight: 500, color: '#212121',
                                        }}
            ...
            <div style={{with: 871 / proporcional, height: 'auto'}}>
                <div className='d-flex' 
                    ...
                    <div className='d-flex shadow-sm bg-white rounded' 
                        ...
                        <div className='d-flex justify-content-center' style={{width: 207 / proporcional, height: 32 / proporcional, marginTop: 9 / proporcional,
                ...
                <div style={{width: 871 / proporcional, height: 'auto', marginBottom: 25 / proporcional}}>
                    <div className='d-flex shadow-sm bg-white rounded' 
                        ...
                        <textarea 
                                disabled={!editar}
                            style={{fontFamily: 'Mukta, sans-serif', width: 267 / proporcional, height: 98 / proporcional, fontSize: 18 / proporcional, lineHeight: `${46 / proporcional}px`, fontWeight: 500, color: '#212121',
                                    }}
                            cols={2}
                            className='form-control border-0 '
