...
export default function DetallesProductoCell({proporcional}) {
    ...
    return (
        <div className='position-relative' 
            ...
            <div style={{width: '100%', height: 110 / proporcional, marginBottom: 20 / proporcional}}>
                <div className='d-flex shadow-sm bg-white rounded' 
                    style={{width: '100%', height: 94 / proporcional, border: '1px solid #B2DFDB',
                                                borderRadius: 4 / proporcional}}>
                    <textarea
                        disabled={!editar} 
            ...
            <div className='d-flex justify-content-between' style={{width: '100%', hight: 'auto'}}>
                <div style={{width: '49%', height: 'auto'}}>
                    {
                        foto_nueve === '' ? ( 
                            <div className='' 
                ...
                open_menu_derecho ? ( 
                    <div className='position-absolute shadow rounded' 
                        ...
                        <div className='d-flex' style={{width: 270 / proporcional, height: 'auto', marginBottom: 10 / proporcional, cursor: 'pointer'}}
                            ...
                            <img src={editar ? icono_cancelar : icono_editar} style={{width: 49 / proporcional, height: 24 / proporcional, marginRight: 10 / proporcional}}/>
