...
export default function HomeDashboard({proporcional}) {
  ...
  return (
    <div className='' 
      style={{width: '100%', paddingLeft: 220 / proporcional,
              paddingRight: 220 / proporcional, paddingTop: 50 / proporcional, paddingBottom: 50 / proporcional}}>
      <div className='d-flex' style={{width: '100%', marginBottom: 100 / proporcional}}>
          <div style={{width: 250 / proporcional, height: 300 / proporcional, marginRight: 182.5 / proporcional}}>
          ...
          <div style={{width: 250 / proporcional, height: 300 / proporcional,
                        marginRight: 182.5 / proporcional, marginLeft: 182.5 / proporcional}}>
            <div className='shadow-lg rounded-circle position-relative' 
          ...
          <div style={{width: 250 / proporcional, height: 300 / proporcional, marginLeft: 182.5 / proporcional}}>
            <div className='shadow-lg rounded-circle position-relative' 
        ...
        <div className='d-flex' style={{width: '100%', marginTop: 100 / proporcional}}>
          <div style={{width: 250 / proporcional, height: 300 / proporcional,
                        marginRight: 182.5 / proporcional}}>
          </div>
          <div style={{width: 250 / proporcional, height: 300 / proporcional,
                        marginRight: 182.5 / proporcional, marginLeft: 182.5 / proporcional}}>
            <div className='shadow-lg rounded-circle position-relative' 
