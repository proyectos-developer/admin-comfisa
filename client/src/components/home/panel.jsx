...
export default function HomePanel({proporcional}) {
  ...
  return (
    <div style={{width: '100%'}}>
        <div className='position-relative' style={{width: '100%', height: 75 / proporcional, background: 'rgb(56, 77, 167)', padding: 12.5 / proporcional,
        ...
        {
          open ? (
            <div style={{width: 300 / proporcional, background: 'rgba(56, 77, 167, 0.9)', height: 842 / proporcional, padding: 20 / proporcional, top: 75 / proporcional,
                zIndex: 99999}} 
