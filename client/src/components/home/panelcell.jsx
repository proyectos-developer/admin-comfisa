...
export default function HomePanelCell({proporcional}) {
  ...
  return (
    <div style={{width: 499 / proporcional}}>
        <div className='position-relative' style={{width: 499 / proporcional, height: 75 / proporcional, background: 'rgb(56, 77, 167)', paddingTop: 12.5 / proporcional,
            paddingBottom: 12.5 / proporcional, paddingLeft: 20 / proporcional, paddingRight: 20 / proporcional, borderBottom: '1px solid #212121'}}>
            ...
            <p onClick={() => navigate ('/home')} className='position-absolute top-50 start-50 translate-middle'
              style={{fontSize: 28 / proporcional, lineHeight: `${48 / proporcional}px`, color: 'rgba(189, 189, 189, 0.6)', fontWeight: 700 / proporcional, cursor: 'pointer',
                     height: 62 / proporcional, padding: 5 / proporcional}}>
                GRUPO COMFISA
            </p>
            <p onClick={() => navigate ('/home')} className='position-absolute top-50 start-50 translate-middle'
              style={{fontSize: 26 / proporcional, lineHeight: `${48 / proporcional}px`, color: 'white', fontWeight: 700 / proporcional, cursor: 'pointer',
        ...
        {
          open ? (
            <div style={{width: 400 / proporcional, background: 'rgba(56, 77, 167, 0.9)', height: '100%', padding: 20 / proporcional, top: 75 / proporcional,
                zIndex: 99999}} 
                className='shadow-sm position-absolute start-0'>
                <div style={{width: 360 / proporcional, height: 57 / proporcional, marginBottom: 20 / proporcional}}>
                    <div className='d-flex' style={{width: 360 / proporcional, height: 35 / proporcional, marginBottom: 10 / proporcional, cursor: 'pointer'}} 
                    ...
                    <div style={{width: 360 / proporcional, height: 2 / proporcional, background: 'white'}}/>
                </div>
                <div style={{width: 360 / proporcional, height: 57 / proporcional, marginBottom: 20 / proporcional}}>
                    <div className='d-flex' style={{width: 360 / proporcional, height: 35 / proporcional, marginBottom: 10 / proporcional, cursor: 'pointer'}}
