            ...
            <div className='d-flex' style={{width: '100%', height: 50 / proporcional, marginBottom: 25 / proporcional }}>
                <div className='d-flex justify-content-between' style={{width: '100%', height: 50 / proporcional}}>
                    ...
                    <div className='shadow-sm' 
                        style={{width: '32%', height: 50 / proporcional, border: '1px solid #B2DFDB', borderRadius: 4 / proporcional, background: 'white'}}>
                        <select
                        ...
                        lista_proveedores.map ((proveedor, numprov) => {
                            return (
                                <div key={numprov} className='d-flex justify-content-between' 
                                    ...
                                    {
                                        proveedores[(2 *  numprov)] ? ( 
                                            <CardProveedorTablet proveedor={proveedores[(2 *  numprov)]} key={(2 *  numprov)} index={(2 *  numprov)} proporcional={proporcional}/>
                                        ) : null
                                    }
                                    {
                                        proveedores[(2 *  numprov) + 1] ? ( 
                                            <CardProveedorTablet proveedor={proveedores[(2 *  numprov) + 1]} key={(2 *  numprov) + 1} index={(2 *  numprov) + 1} proporcional={proporcional}/>
                                        ) : null
                                    }
                                </div>
                            )
