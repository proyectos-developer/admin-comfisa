...
export default function CardProveedorCell({proveedor, index,proporcional}) {
    ...
    return (
        <div key={index} className='d-flex shadow rounded' style={{width: '99%', height: '100%', padding: 10 / proporcional}}>
