...
export default function CardProveedorTablet({proveedor, index,proporcional}) {
    ...
    return (
        <div key={index} className='d-flex shadow rounded' style={{width: 415.5 / proporcional, height: 176 / proporcional, padding: 10 / proporcional, marginLeft: 10 / proporcional,
          marginRight: 10 / proporcional}}>
            ...
            <div style={{width: 229.5 / proporcional, height: 156 / proporcional}}>
              <p style={{fontSize: 20 / proporcional, lineHeight: `${30 / proporcional}px`, marginBottom: 0, fontWeight: 700, color: 'rgb(56, 77, 167)'}}>
                {proveedor.proveedor}
              </p>
              <div style={{width: 229.5 / proporcional, height: 96 / proporcional}}>
              ...
              <div style={{width: 229.5 / proporcional, height: 30 / proporcional}} className='d-flex justify-content-end'>
