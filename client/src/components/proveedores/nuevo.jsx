...
export default function NuevoProveedor({proporcional}) {
    ...
    return (
        <div className='position-relative' 
            ...
            <div className='d-flex justify-content-between' style={{wwidth: '100%', height: 278 / proporcional, marginBottom: 50 / proporcional}}>
                <div style={{width: '39%', height: 280 / proporcional, border: efoto_logo ? '1px solid red' : 'none', marginRight: 23 / proporcional}}>
                    {
                        foto_logo === '' ? ( 
                            <div className='' 
                                ...
                                <div className='position-relative' style={{width: '100%', height: 48 / proporcional}}>
                                    <div id='imagen' className='position-absolute start-50 translate-middle' type='button' onClick={() => handle_editar_picture()}
                                        style={{ left: 150.5 / proporcional, bottom: 24 / proporcional, width: 48 / proporcional, height: 48 / proporcional, cursor: 'pointer'}}>
                                        <img src={icono_camera} style={{wtdth: 48 / proporcional, height: 48 / proporcional, cursor: 'pointer'}}/>
                ...
                <div style={{width: '49%', height: 50 / proporcional, marginLeft: 25 / proporcional}}>
                    <div className='d-flex shadow-sm bg-white rounded' 
                        style={{width: '100%', height: 50 / proporcional, border: enombre_proveedor ? '1px solid red' : '1px solid #B2DFDB', 
                    ...
                    <div style={{width: '100%', height: 168 / proporcional, marginBottom: 5 / proporcional}}>
                        <div className='shadow-sm bg-white rounded' style={{width: '100%', height: 150 / proporcional, border: '1px solid #B2DFDB', 
                            ...
                            <textarea
                                ...
                                style={{fontFamily: 'Mukta, sans-serif', width: '100%', height: 146 / proporcional, fontSize: 18 / proporcional, lineHeight: `${18 / proporcional}px`, fontWeight: 500, color: '#212121'}}
                                className='form-control border-0 '
                    ...
                    <div className='d-flex shadow-sm bg-white rounded' 
                        style={{width: '100%', height: 50 / proporcional, border: ecorreo ? '1px solid red' : '1px solid #B2DFDB', 
                                                    borderRadius: 4 / proporcional}}>
                        <p style={{fontFamily: 'Mukta, sans-serif', width: '40%', height: 48 / proporcional, fontSize: 16 / proporcional, 
                                    lineHeight: `${48 / proporcional}px`, color: '#757575', marginLeft: 10 / proporcional, fontWeight: 600, cursor: 'default'}} className='mb-0'>
                                        Correo electrónico:
            ...
            <div style={{with: '100%', height: 50 / proporcional}}>
                ...
                <div className='' style={{with: '100%', height: 50 / proporcional}}>
                    <div className='d-flex shadow-sm bg-white rounded' 
                        ...
                        <input type='number'
                            style={{fontFamily: 'Mukta, sans-serif', width: '80%', height: 46 / proporcional, fontSize: 18 / proporcional, fontWeight: 500, color: '#212121',
                                    }}
                            className='form-control border-0 '
                            value={direccion}
